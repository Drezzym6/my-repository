...
# response = ssm.get_parameter(Name='/clarusway/andre/password')
# pw = response['Parameter']['Value']
# response = ssm.get_parameter(Name='/clarusway/andre/endpoint')
# db = response['Parameter']['Value']
pw="Clarusway_1"
db= "andre-rds-flask.ch0s8cq6g7q9.us-east-1.rds.amazonaws.com"
